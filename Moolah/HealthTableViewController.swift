...
class HealthTableViewController: UITableViewController {
    ...
    func search()
    {
        let todoEndpoint: String = "https://hackcarbonserver.herokuapp.com/get_deals?lat=\(lat)&long=\(long)&category=health"
        ...
        let task = session.dataTask(with: urlRequest) { data, response, error in
            ...
            do {
                ...
                guard let health = jsonResponse["deals"] as? [[String: Any]] else {
                    print("health err")
                    return
                }
                for obj in health {
