//
//  ShopNighLifeTableViewController.swift
//  Moolah
//
...
class ShopNighLifeTableViewController: UITableViewController {
    ...
    func search()
    {
        let todoEndpoint: String = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=\(lat),\(long)&radius=500&&&type=night_club&maxprice=2&key=AIzaSyD4cb_s4PA8VThsRwH6jhT-rPPZCs-Pssc"
